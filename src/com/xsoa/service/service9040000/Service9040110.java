...
public class Service9040110 extends BaseService {
	private DBManager db = null;

	public Service9040110() {
		db = new DBManager();
	}
	/**
	 * 
	 ...
	 * @return int
	 * @author ztz
	 * @date 2015年2月2日 下午2:57:16
	 */
	public int getBmxxDataCount(Pojo9040110 beanIn) throws Exception {
		int result = 0;
	 ...
	 * @return
	 * @throws Exception
	 * @return List<Pojo9040110>
	 * @author ztz
	 * @date 2015年2月2日 下午2:57:30
	 */
	public List<Pojo9040110> getBmxxDataList(Pojo9040110 beanIn, int page,
			int limit, String sort) throws Exception {
		List<Pojo9040110> result = null;
		...
		try {
			...
			ResultSetHandler<List<Pojo9040110>> rs = new BeanListHandler<Pojo9040110>(
					Pojo9040110.class);
	 ...
	 * @return String
	 * @author ztz
	 * @date 2015年2月2日 下午2:57:50
	 */
	private String searchSql(Pojo9040110 beanIn) throws Exception {
		StringBuffer strbuf = new StringBuffer();
