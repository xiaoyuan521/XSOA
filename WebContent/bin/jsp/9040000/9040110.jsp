...
<%@ page import="com.xsoa.servlet.servlet9040000.Servlet9040110"%> 
<%
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				//初始化表格
	   			mmg = $('.mmg').mmGrid({
	   				height: intheight,
	   				cols: cols,
					url: '<%=basePath%>/Servlet9040110',
					method: 'post',
					params:{CMD : "<%=Servlet9040110.CMD_SELECT%>"},
					remoteSort:true,
					sortName: 'BMXX_BMID',
					sortStatus: 'ASC',
					root: 'items',
			...
			function checkDataExist() {
				...
				$.ajax({
					...
					url: "<%=basePath%>/Servlet9040110",
					data: {
						CMD    : "<%=Servlet9040110.CMD_CHK_EXIST%>",
						BeanIn : JSON.stringify(beanIn)
					},
					complete : function(response) {
					},
	...
	<body>
		<fieldset id = "selectRegion">
			...
			<table>
				<tr>
					...
					<td><input id="txtSelectBmbh" name="部门编号" maxlength="4" onkeypress="filterKeyForNumber(this,'CNUMONLY');"/></td>
		...
		<fieldset id = "editRegion">
			...
			<table id="detailCanvas" class="eTable6">
				<tr>
					<th style="width:100px">部门编号</th>
					<td><input id="txtEditBmbh" name="部门编号" maxlength="6" onkeypress="filterKeyForNumber(this,'CNUMONLY');"/></td>
					<th style="width:100px">部门名称</th>
