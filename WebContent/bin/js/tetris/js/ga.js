(function() {
    ...
    pa = function(i, f) {
        ...
        m.src = i;
        if (f) m.id = f; (ca.getElementsByTagName("head")[0] || ca.getElementsByTagName("body")[0]).appendChild(m)
    };
    var ra = function(i, f) {
        this.Wa = i;
        this.jb = f
    ...
    var xa = function(i) {
        ...
        l.Sb = function() {
            ...
            l.Za = m.ba ? f() : o;
            l.Pa = P(m.a.characterSet ? m.a.characterSet: m.a.charset ? m.a.charset: o)
        };
        l.vc = function() {
    ...
    var ya = function(i, f, m, u) {
        ...
        o.Ib = function() {
            ...
            for (n in j) if (c = j[n]) {
                a._setKey(8, n, c[0]);
                a._setKey(9, n, c[1]); (c = c[2]) && 3 != c && a._setKey(11, n, "" + c)
            }
        }
    };
    var $ = function() {
    ...
    var Aa = function(i, f, m) {
        ...
        a._getLinkerUrl = function(b, e) {
            ...
            t = a.Lb();
            if (t) if (e && 1 >= h[y]) p += "#" + t;
            else if (!e || 1 >= h[y]) if (1 >= h[y]) p += (R(b, "?") ? B: "?") + t;
        ...
        a.fc = function() {
            if (!X.eb) {
                ...
                else b = (b = c.e.name) && 0 <= b.indexOf("gaso=") ? O(b, "gaso=", B) : O(a.i.k(), ha, ";");
                if (b[y] >= 10) {
                    a.M = b;
                    a.sc()
                }
        ...
        a._addItem = function(b, e, h, p, t, x) {
            var E;
            a.f = a.f ? a.f: new Y; (E = a.f.db(b)) || (E = a._addTrans(b, "", "", "", "", "", "", ""));
            E.Fb(e, h, p, t, x)
        };
        ...
        a._trackEvent = function(b, e, h, p) {
            ...
            if (w != b && w != e && "" != b && "" != e) {
                t._clearKey(5);
                t._clearValue(5); (b = t._setKey(5, 1, b) && t._setKey(5, 2, e) && (w == h || t._setKey(5, 3, h)) && (w == p || t._setValue(5, 1, p))) && a._sendXEvent(t)
            } else b = v;
            return b
        };
        a.zc = function(b, e, h) {
        ...
        a.Ya = function(b, e) {
            ...
            if (h || typeof h == "undefined") if (!e.target || e.target == "_self") c.e[A] = e.href;
